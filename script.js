const questions = [
  ...
  {
    text: "実際に調べて下さい。\n\n「マグミット330mg3錠　分3毎食後」医師の指示により粉砕。自家製剤加算を算定できるか。",
    answer: false,
    explanation: "マグミットには散剤が薬価収載されているので、自家製剤加算は算定できない"
  },
  {
    text: "実際に調べて下さい。\n\n「プレドニン錠5mg　0.5錠　分1朝食後」を調剤。自家製剤加算を算定できるか。",
    answer: false,
    explanation: "プレドニンの一般名（プレドニゾロン）を検索すると2.5㎎のものが確認出来るので、自家製剤加算を算定できない。"
  }
,
  {
    text: "実際に調べて下さい。\n\n「カロナール200mg　1回1.5錠　疼痛時服用」を調剤。自家製剤加算を算定できるか。",
    answer: false,
  ...
  {
    text: "実際に調べて下さい。\n\n「グリメピリド錠3mg　1.5錠　分1朝食後」を調剤。自家製剤加算を算定できるか。",
    answer: true,
  ...
  {
    text: "実際に調べて下さい。\n\n「センノシド錠　1錠　分1夕食後　医師の指示により粉砕」　自家製剤加算を算定できるか。",
    answer: true,
  ...
  {
    text: "実際に調べて下さい。\n\n処方１　ビソプロロール錠2.5mg　0.5錠　朝食後　7日分\n　処方２　アジルサルタン錠10mg　0.5錠　朝食後　14日分\n　2剤とも自家製剤加算を算定できるか。",
    answer: true,
