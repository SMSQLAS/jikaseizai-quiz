const questions = [
  {
    text: "錠剤を半錠に割って調剤した。<br>薬価基準に同一規格の半量規格がない場合、自家製剤加算を算定できるか。",
    answer: true,
    explanation: "同一剤形・同一規格で代替できる薬価収載品がない場合は、割錠による自家製剤加算の対象になり得ます。"
  },
  {
    text: "錠剤を粉砕したが、同一成分の散剤が薬価基準に収載されている。<br>この場合、自家製剤加算を算定できるか。",
    answer: false,
    explanation: "同一成分・同一剤形などで代替できる薬価収載品がある場合は、原則として算定できません。"
  },
  {
    text: "カプセルを脱カプセルして粉末として調剤した。<br>患者が嚥下困難で、医師の指示がある場合、自家製剤加算を算定できるか。",
    answer: true,
  ...
  {
    text: "散剤が供給不足により手に入らない為、錠剤を粉砕した。<br>この場合、自家製剤加算を算定できるか。",
    answer: true,
    explanation: "供給上の問題により当該医薬品が入手困難であり、調剤を行う際に必要な数量を確保できない場合は算定可能です。"
  },
  {
    text: "錠剤を半錠にし、他の薬と一緒に一包化をした為、外来服薬支援料2を算定した。<br>この場合、半錠にした薬は自家製剤加算を算定できるか。",
    answer: false,
    explanation: "外来服薬支援料2を算定した範囲の薬剤については、自家製剤加算は算定できない。"
  },
  {
    text: "実際に調べて下さい。<br><br>「マグミット330mg3錠　分3毎食後」医師の指示により粉砕。<br>自家製剤加算を算定できるか。",
    answer: false,
    explanation: "マグミットには散剤が薬価収載されているので、自家製剤加算は算定できない"
  },
  {
    text: "実際に調べて下さい。<br><br>「プレドニン錠5mg　0.5錠　分1朝食後」を調剤。自家製剤加算を算定できるか。",
    answer: false,
    explanation: "プレドニンの一般名（プレドニゾロン）を検索すると2.5㎎のものが確認出来るので、自家製剤加算を算定できない。"
  }
,
  {
    text: "実際に調べて下さい。<br><br>「カロナール200mg　1回1.5錠　疼痛時服用」を調剤。<br>自家製剤加算を算定できるか。",
    answer: false,
    explanation: "200mgを1.5錠で分包したとしても、同量に相当する300mgがあるので、自家製剤加算を算定できない。"
  },
  {
    text: "ベストロン点眼液を、粉末を溶解し、使えるようにしてお渡しした。<br>自家製剤加算を算定できるか。",
    answer: false,
    explanation: "液剤を調剤する時に用時溶解して使用するとされている医薬品を交付する時に溶解した場合は算定対象とならない。"
  },
  {
    text: "実際に調べて下さい。<br><br>「グリメピリド錠3mg　1.5錠　分1朝食後」を調剤。<br>自家製剤加算を算定できるか。",
    answer: true,
    explanation: "既存の規格の組み合わせ（1mg＋0.5mg）で対応可能な場合でも、半錠の規格が無ければ自家製剤加算を算定できる。"
  },
  {
    text: "割線のない配合錠を半錠にした。自家製剤加算を算定できるか。",
    answer: false,
    explanation: "配合錠の半錠は含量の均一性に保証がないため、依然として自家製剤加算を算定できない。"
  },
  {
    text: "実際に調べて下さい。<br><br>「センノシド錠　1錠　分1夕食後　医師の指示により粉砕」<br>自家製剤加算を算定できるか。",
    answer: true,
    explanation: "センノシド錠の有効成分はセンノシドA・Bのカルシウム塩として12mgでセンノシドは20mgである。<br>センノシドで調べると出てくるアローゼン顆粒は一般名「センナ・センナ実配合顆粒」でセンナ577.9mg＋センナ実385.3mg。<br>有効成分が同一ではないため自家製剤加算を算定できる。"
  },
  {
      text: "実際に調べて下さい。<br><br>処方１<br>ビソプロロール錠2.5mg　0.5錠　朝食後　7日分<br>処方２<br>アジルサルタン錠10mg　0.5錠　朝食後　14日分<br><br>2剤とも自家製剤加算を算定できるか。",
    answer: true,
    explanation: "自家製剤加算は「1調剤につき」算定することができる。<br>ここでいう「1調剤」とは、内服薬の場合、必ずしも薬剤調整料の「1剤」と全く同じ区分になるわけではない。<br>服用時点は同一で調剤日数のみ異なるような場合には、薬剤調整料は1剤となりますが、調剤行為については「それぞれ1調剤」として取り扱う。<br>したがってこのケースは2調剤行為として取り扱うので、自家製剤加算もそれそれ算定できる。"
