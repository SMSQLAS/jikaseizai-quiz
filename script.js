...
,
  ...
  },
  {
    ...
    answer: true,
    explanation: "自家製剤加算は「1調剤につき」算定することができる。ここでいう「1調剤」とは、内服薬の場合、必ずしも薬剤調整料の「1剤」と全く同じ区分になるわけではない。服用時点は同一で調剤日数のみ異なるような場合には、薬剤調整料は1剤となりますが、調剤行為については「それぞれ1調剤」として取り扱う。したがってこのケースは2調剤行為として取り扱うので、自家製剤加算もそれそれ算定できる。"
